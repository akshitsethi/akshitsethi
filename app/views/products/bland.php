	...
	<div class="s-container">
		<div class="s-row">
			<div class="s-md-8 s-sm-7">
				<h1>Bland</h1>
				<p class="theme-description">Bland is a clean and minimal blog theme perfect for bloggers who need to create personal blog site with simple creative features. It mixes between modern, classic and minimal styles and will help you create a simple and clean blog. <strong>Compatible upto WordPress 4.9.2</strong></p>
			</div><!-- .s-md-8 -->

			<div class="s-md-4 s-sm-5">
				<div class="theme-buttons right paypal-form">
					<a href="http://demo.akshitsethi.com/bland" target="_blank" class="button">Live Demo</a>
					<a href="<?php echo $config['url']; ?>/products/bland.zip" target="_blank" class="button download">Download</a>
				</div><!-- .theme-buttons -->
			</div><!-- .s-md-4 -->
		</div><!-- .s-row -->
